    ...
    <>
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              ...
              endosperma. Setiap buah umumnya memiliki dua biji. - wikipedia
            </p>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                href="/menu"
                rel="noopener"
                className="px-8 py-4 text-lg font-medium text-center text-white bg-yellow-800 hover:bg-yellow-600 rounded-md "
              >
                Get Started
              </a>
              <a
        ...
        <div className="flex items-center justify-center w-full lg:w-1/2">
          <div className="">
            <img src="unDraw_Coffee.png" alt="Foo eating a sandwich." />
            {/* <Image
              src={heroImg}
              width="616"
              height="617"
